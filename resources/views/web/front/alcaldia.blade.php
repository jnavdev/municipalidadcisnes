                    ...
                    <div class="block-content">
                        ...
                        <div class="single-post-box">
                                    ...
                                    <div class="col-md-6">
                                        <div class="image-content">
                                            <div class="image-place">
                                                <img src="{{ asset('assets/web/images/concejo/Alcalde.png') }}" alt="">
                                                <div class="hover-image">
                                                    <a class="zoom" href="{{ asset('assets/web/images/concejo/Alcalde.png') }}">
                                                        <i class="fa fa-arrows-alt"></i>
                                                    </a>
                                                </div>
                                            </div>
                                            <h5>Alcalde  Francisco Roncagliolo.</h5>
                                            <span class="image-caption">@municipalidadcisnes.cl</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="share-post-box">
                                <ul class="share-box">
                                    <li><i class="fa fa-share-alt"></i><span><strong>Secretaria</strong></span></li>
                                </ul>
                            </div>
                            <div class="prev-next-posts">
                                <div class="prev-post">
                                    <img src="{{ asset('assets/web/images/equipo/servicio1.png') }}" alt="">
                                    <div class="post-content">
                                        <h2><a href="#" title="prev post">Nombre Secretaria <br>+56 672 247701 </a></h2>
                                        <h2><a href="#" title="prev post">@municipalidadcisnes.cl </a></h2>
                                ...
                                <div class="col-md-6">
                                    <div class="news-post standard-post2">
                                        ...
                                        <div class="post-title">
                                            ...
                                            <h2><a href="#">Fono: +56 67 2247713 </a></h2>
                                            <h2><a href="#">Mail: @municipalidadcisnes.cl</a></h2>
                                            <!-- <ul class="post-tags">
                                                <li><i class="fa fa-clock-o"></i>27 may 2013</li>
                                                <li><i class="fa fa-user"></i>by <a href="#">John Doe</a></li>
