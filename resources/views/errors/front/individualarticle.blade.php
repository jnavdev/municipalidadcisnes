                        ...
                        <div class="single-post-box">
                            ...
                            <div class="share-post-box">
                                <ul class="share-box">
                                    ...
                                    <li><a class="twitter" target="_blank" href="http://twitter.com/share?text={{ $article->title }}&via=muniptovaras"><i class="fa fa-twitter"></i><span>Compartir en Twitter</span></a></li>
                                </ul>
                            </div>
